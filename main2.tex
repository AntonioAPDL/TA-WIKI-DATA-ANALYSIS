...
Finally, the study reflects one stage of one Wiki implementation. Some issues raised in the survey, including duplicated content, maintenance responsibility, and contribution pathways, are features of the current implementation that may change as the Wiki is revised. The project's novelty should also be interpreted carefully: the contribution is not simply that a department has a Wiki, but that the Wiki is GitHub-hosted, organized around TA resources, and designed to support student contribution and course-material sharing.
